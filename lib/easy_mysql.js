 ...
 *  This is probably not a good idea, but may be fine for code where you don't
 *  want to set up a pool, such as in unit tests.
 *
 *  2. Custom Pool: Pass in your own pool object.  It must have functions named
 *  'acquire' and 'release'. See example in <easy_pool>.
 *
